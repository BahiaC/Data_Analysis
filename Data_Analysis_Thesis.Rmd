...
depression2017_fil<- filter_taxa(depression2017_1, function(x) sum(x)>=10 & sum(x>0)>0.1*length(x), TRUE)

#2798 taxa and 138 samples
depression2017_fil

#Rarefy to 11175
depression2017_rare<-rarefy_even_depth(depression2017_fil, sample.size=11175, rngseed=711, replace=FALSE, trimOTUs=TRUE)

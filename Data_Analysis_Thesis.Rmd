...
##6843OTUs were removed because they are no longer present in any sample after random subsampling

#11852 taxa and 132 samples (lost negative controls and two samples that only had max 15 seqs)
depression2017_1rare
...
#1318 taxa and 132 samples
depression2017_1rare_fil
```
...
plot_richness(depression2017_1rare_fil, x="Participant", measures=c("Observed", "Chao1","Shannon"))+
...
depression_rare_richness<-as.matrix(estimate_richness(depression2017_1rare_fil, measures=c("Observed","Chao1","Shannon")))

##don't need this - row names are correct
#row.names(practice2017_rare_richness)<-row.names(sample_data(practice2017_rare))

depression_rare_richness<-cbind(depression_rare_richness,sample_data(depression2017_1rare_fil))
...
##Kruskal-wallis rank sum test, pvalue 0.7935, thus no significant difference between populations, null hypothesis assumes samples are from identical populations
...
##data:  Observed by Dep_Con W = 762, p-value = 0.4822
##alternative hypothesis: true location shift is not equal to 0

wilcox.test(Observed ~ Con_A, data=depression_rare_richness)
##data:  Observed by Con_A W = 170, p-value = 0.3028
##alternative hypothesis: true location shift is not equal to 0
...
##data:  Observed by Con_B W = 230.5, p-value = 0.8011
##alternative hypothesis: true location shift is not equal to 0

##Warning message:
##In wilcox.test.default(x = c(511, 437, 539, 446, 343, 442, 416,  :
  ##cannot compute exact p-value with ties

wilcox.test(Observed ~ Pre_ProA, data=depression_rare_richness)
##data:  Observed by Pre_ProA W = 227, p-value = 0.88
##alternative hypothesis: true location shift is not equal to 0
...
##data:  Observed by Pre_PostB W = 263.5, p-value = 0.622
##alternative hypothesis: true location shift is not equal to 0
...
##data:  Observed by ProA_B W = 180.5, p-value = 0.2244
##alternative hypothesis: true location shift is not equal to 0
...
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 302683 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 213885 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 369602 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 367946 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 183686 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 188433 -- in the phylogenetic tree in the data you provided.
...
##Warning message:
##In UniFrac(physeq, weighted = TRUE, ...) :
  ##Randomly assigning root as -- 175438 -- in the phylogenetic tree in the data you provided.

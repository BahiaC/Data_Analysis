...
severemild<-depression_smelt_1 %>% filter(Participant=="Pre") %>% filter(Severe_Mild %in% c("severe", "mild")) %>% filter(OTU=="295748") %>% group_by(Severe_Mild, OTU) %in% select(OTU, Abundance, Severe_Mild)
